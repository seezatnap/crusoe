...
- [x] (#8) Define the style-and-voice protocol targeting prose in the style of J. K. Rowling: character-forward, scene-driven, emotionally restrained yet emotionally legible prose with anti-cliché constraints and tone-alternation rules for Lattice vs recording chapters [5 pts] (blocked by #2, #7) (A)
