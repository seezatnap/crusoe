...
## Follow-up tasks (from sprint review)
- [A] (#79) Regenerate `writing-artifacts/reports/final-editorial-handoff-2026-02-13/` end-to-end so the frozen `planning/roadmap.md` and `postmortems/chapter-16-postmortem-2026-02-13.md` / `chapter-17-postmortem-2026-02-13.md` are synchronized to the active 4,739 and 4,055 word-count metadata after the #77/#78 sync work (blocked by #77, #78).
- [A] (#80) Fix the stale quality link in `writing-artifacts/reports/final-editorial-handoff-2026-02-13/postmortems/chapter-15-postmortem-2026-02-13.md` (`quality-orchestrator-1770995384.md`) by replacing it with a real existing artifact or regenerating the handoff bundle so all handoff links resolve.
