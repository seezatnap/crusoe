...
- [A] (#33) Draft `chapters/chapter-17.md` in the 4,000–6,000-word range: deliver resolution with mixed societal outcomes, final Maren farewell in full drift, and Juno’s return to an honestly uncertain but real future [5 pts] (blocked by #32)
...
## Follow-up tasks (from sprint review)
- [A] (#70) Update `writing-artifacts/roadmap.md` chapter-16 tracker row from `Not started` to `Completed draft (4,706)` (or authoritative word count from canonical script) and align status metadata with `chapters/chapter-16.md` now that draft delivery task `#32` is marked complete (blocked by #32)
