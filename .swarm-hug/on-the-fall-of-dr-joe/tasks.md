...
## Follow-up tasks (from sprint review)
- [A] (#45) Update `tasks.md` to mark `#10` as complete so task tracking matches the committed `CH-001-the-strange-request.md` delivery (word-complete chapter in `ready_for_review`).
