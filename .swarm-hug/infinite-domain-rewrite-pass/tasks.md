...
## Follow-up tasks (from sprint review)
- [A] (#95) Fix 12 error-level findings in `final-draft-chapters/chapter-05.md` — 6 DIAL-TAG-001 weak pronoun-based speaker attributions (lines 87, 229, 287, 347, 457, 483) and 6 corresponding POV-DRIFT-001 errors flagged in quality-orchestrator report 1771017751, which caused the report to fail with 1 blocking report — this is the same class of error fixed in every other chapter (tasks #36, #39, #40, #54, #56, #60, #65, #71, #75, #85, #88) but chapter-05 was missed
- [B] (#96) Clean up the 11 stale quality-orchestrator reports for chapter-05 (timestamps 1770990699, 1770990722, 1770990767, 1770990778, 1770990802, 1770990814, 1770991141, 1770992563, 1770992617, 1770992621, 1770992636) that target `chapters/chapter-05.md` instead of `final-draft-chapters/chapter-05.md`
- [ ] (#97) Re-run quality-orchestrator on `final-draft-chapters/chapter-05.md` after DIAL-TAG-001 fixes are applied — the current report 1771017751 was generated before both the dialogue-tag fixes and the POV marker stripping (task #94), so it does not reflect the actual post-fix state (blocked by #95)
- [A] (#98) Fix 12 error-level findings in `final-draft-chapters/chapter-05.md` — 6 DIAL-TAG-001 weak pronoun-based speaker attributions (lines 87, 229, 287, 347, 457, 483) and 6 corresponding POV-DRIFT-001 errors flagged in quality-orchestrator report 1771017751, which caused the report to fail with 1 blocking report — same class of error fixed in every other chapter but chapter-05 was missed (A)
