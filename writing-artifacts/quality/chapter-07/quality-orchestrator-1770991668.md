...
- metadata:
  ...
  - sentences: 645
- details:
  - [blocker] CLIC-CLICHÉ-01 at chapters/chapter-07.md:4:1
    - Cliche phrase repeated 10 times: "as if".
...
- metadata:
  ...
  - character_list: it, fine, mine, juno, cassiel, you, i, fen, no cassiel
...
- details:
  ...
  - [error] VOICE-STYLE-001 at chapters/chapter-07.md:362:1
    - Voice drift risk for 'i' (similarity 0.40, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
...
signature: fnv1a64:e5b12a9fe9e2f1c7
