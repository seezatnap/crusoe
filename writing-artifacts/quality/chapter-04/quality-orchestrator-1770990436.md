...
- details:
  - [info] POV-MARKER-001 at chapters/chapter-04.md:235:1
  ...
  - [info] POV-MARKER-001 at chapters/chapter-04.md:245:1
    - First-person narration has no visible POV marker (`<!-- pov: <name> -->`).
    - suggestion: Add a POV marker before this paragraph or confirm expected focalization shift in your chapter metadata.
  - [info] POV-MARKER-001 at chapters/chapter-04.md:311:1
    - First-person narration has no visible POV marker (`<!-- pov: <name> -->`).
    - suggestion: Add a POV marker before this paragraph or confirm expected focalization shift in your chapter metadata.
  - [info] POV-MARKER-001 at chapters/chapter-04.md:315:1
    - First-person narration has no visible POV marker (`<!-- pov: <name> -->`).
    - suggestion: Add a POV marker before this paragraph or confirm expected focalization shift in your chapter metadata.


signature: fnv1a64:344cd0b699a8c6be
