...
- metadata:
  ...
  - character_list: marcus, i, they, lena, dara, he, it, sable
...
- details:
  - [info] DIAL-AMBIG-001 at final-draft-chapters/chapter-05.md:265:1
    - Ambiguous dialogue attribution: multiple candidates around line 265, likely 'marcus' with confidence 0.95.
  ...
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:167:1
    - Dialogue uses continuation inference for 'sable'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:213:1
    - Dialogue uses continuation inference for 'sable'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  ...
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:227:1
    - Dialogue uses continuation inference for 'they'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:249:1
    - Dialogue uses continuation inference for 'they'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  ...
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:255:1
    - Dialogue uses continuation inference for 'they'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:263:1
    - Dialogue uses continuation inference for 'they'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:269:1
    ...
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:273:1
    - Dialogue uses continuation inference for 'marcus'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:291:1
    - Dialogue uses continuation inference for 'it'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:293:1
    - Dialogue uses continuation inference for 'it'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:365:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:369:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:371:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:375:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:389:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [info] DIAL-TAG-002 at final-draft-chapters/chapter-05.md:401:1
    - Dialogue uses continuation inference for 'lena'; confidence 0.72.
    - suggestion: Add an explicit dialogue tag when the speaker switches or scene changes.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:63:1
    - Dialogue speaker 'dara' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
  ...
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:67:1
    - Dialogue speaker 'dara' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:77:1
    - Dialogue speaker 'dara' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:79:1
    - Dialogue speaker 'dara' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:89:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:91:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:93:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:95:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:139:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:151:1
    - Dialogue speaker 'sable' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  ...
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:167:1
    - Dialogue speaker 'sable' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:213:1
    - Dialogue speaker 'sable' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:215:1
    - Dialogue speaker 'sable' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:217:1
    - Dialogue speaker 'sable' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  ...
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:225:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:227:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:249:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:251:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:255:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:263:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:269:1
    - Dialogue speaker 'marcus' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:273:1
    - Dialogue speaker 'marcus' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:291:1
    - Dialogue speaker 'it' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:293:1
    - Dialogue speaker 'it' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:365:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:369:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:371:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:375:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:389:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [warning] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:401:1
    - Dialogue speaker 'lena' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  ...
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:167:1
    - Voice drift risk for 'sable' (similarity 0.22, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:213:1
    - Voice drift risk for 'sable' (similarity 0.22, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  ...
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:227:1
    ...
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:249:1
    - Voice drift risk for 'they' (similarity 0.25, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  ...
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:255:1
    - Voice drift risk for 'they' (similarity 0.25, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:263:1
    - Voice drift risk for 'they' (similarity 0.25, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:275:1
    - Voice drift risk for 'dara' (similarity 0.30, weighted confidence 0.95).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:341:1
    - Voice drift risk for 'sable' (similarity 0.23, weighted confidence 0.95).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:343:1
    - Voice drift risk for 'lena' (similarity 0.23, weighted confidence 0.95).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:365:1
  ...
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:369:1
    - Voice drift risk for 'lena' (similarity 0.24, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:371:1
    - Voice drift risk for 'lena' (similarity 0.24, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:375:1
    - Voice drift risk for 'lena' (similarity 0.24, weighted confidence 0.72).
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:389:1
  ...
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:401:1
    ...
    - suggestion: Reconcile diction and rhythm with prior dialogue from this character.
  - [warning] VOICE-STYLE-001 at final-draft-chapters/chapter-05.md:471:1
  ...
  - [error] DIAL-TAG-001 at final-draft-chapters/chapter-05.md:223:1
    - Speaker attribution is weak (0.42) for 'they'; source is pronoun-based tag.
    - suggestion: Replace weak or pronoun-only tag with a named character tag for stronger continuity tracking.
  - [error] DIAL-TAG-001 at final-draft-chapters/chapter-05.md:281:1
    - Speaker attribution is weak (0.42) for 'it'; source is pronoun-based tag.
    - suggestion: Replace weak or pronoun-only tag with a named character tag for stronger continuity tracking.
  - [error] DIAL-TAG-001 at final-draft-chapters/chapter-05.md:337:1
    - Speaker attribution is weak (0.42) for 'it'; source is pronoun-based tag.
    - suggestion: Replace weak or pronoun-only tag with a named character tag for stronger continuity tracking.
  - [error] DIAL-TAG-001 at final-draft-chapters/chapter-05.md:445:1
    - Speaker attribution is weak (0.42) for 'i'; source is pronoun-based tag.
    - suggestion: Replace weak or pronoun-only tag with a named character tag for stronger continuity tracking.
  - [error] DIAL-TAG-001 at final-draft-chapters/chapter-05.md:471:1
    - Speaker attribution is weak (0.42) for 'it'; source is pronoun-based tag.
    - suggestion: Replace weak or pronoun-only tag with a named character tag for stronger continuity tracking.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:85:1
    - Dialogue speaker 'he' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:223:1
    - Dialogue speaker 'they' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:281:1
    - Dialogue speaker 'it' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:337:1
    - Dialogue speaker 'it' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:445:1
    - Dialogue speaker 'i' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.
  - [error] POV-DRIFT-001 at final-draft-chapters/chapter-05.md:471:1
    - Dialogue speaker 'it' does not match active POV marker 'juno | layer: recording (lead) | shifts: present → recording → present → recording → present → recording → present'.
    - suggestion: If the POV changed, insert a POV marker before this dialogue block.


signature: fnv1a64:252a0a311682d3b3
